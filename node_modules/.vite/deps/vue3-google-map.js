import {
  ...
  toRef,
  watch
} from "./chunk-JCT72LKO.js";
import "./chunk-VUNV25KB.js";

// node_modules/.pnpm/vue3-google-map@0.23.0_vue@3.5.17_typescript@5.5.4_/node_modules/vue3-google-map/dist/index.mjs
(function() {
  "use strict";
  try {
...
var De = (n3, e, t) => e in n3 ? Ne(n3, e, { enumerable: true, configurable: true, writable: true, value: t }) : n3[e] = t;
var oe = (n3, e, t) => (De(n3, typeof e != "symbol" ? e + "" : e, t), t);
var B = Symbol("map");
var Z = Symbol("api");
...
var q = class _q {
  ...
  constructor({ apiKey: e, authReferrerPolicy: t, channel: s, client: r, id: o = ye, language: a, libraries: l = [], mapIds: i, nonce: d, region: u, retries: c = 3, url: h = "https://maps.googleapis.com/maps/api/js", version: p }) {
    if (this.callbacks = [], this.done = false, this.loading = false, this.errors = [], this.apiKey = e, this.authReferrerPolicy = t, this.channel = s, this.client = r, this.id = o || ye, this.language = a, this.libraries = l, this.mapIds = i, this.nonce = d, this.region = u, this.retries = c, this.url = h, this.version = p, _q.instance) {
      if (!Ge(this.options, _q.instance.options))
...
var We = defineComponent({
  ...
  setup(n3, { emit: e }) {
    ...
    provide(B, r), provide(Z, o), provide(Te, a);
    const l = () => {
      const c = { ...n3 };
...
function Ye(n3, e, t, s, r, o) {
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("div", Ke, null, 512),
...
var Qe = defineComponent({
  ...
  setup(n3, { emit: e, expose: t, slots: s }) {
    const r = ref(), o = computed(() => {
      var p;
      return (p = s.content) == null ? void 0 : p.call(s).some((f) => f.type !== Comment);
    }), a = toRef(n3, "options"), l = toRef(n3, "pinOptions"), i = ref(), d = inject(B, ref()), u = inject(Z, ref()), c = inject(fe, ref()), h = computed(
    ...
    return watch(
      ...
      async (p, [f, m, g]) => {
        ...
        if (i.value) {
          ...
          o.value ? a.value.content = r.value : l.value && (a.value.content = new O(l.value).element), i.value = markRaw(new w(a.value)), h.value ? (M = c.value) == null || M.addMarker(i.value) : i.value.map = d.value, ke.forEach((L) => {
            var Q;
    ...
    }), provide(pe, i), t({ marker: i }), { hasCustomSlotContent: o, markerRef: r };
  }
});
var et = {
  key: 0,
...
function tt(n3, e, t, s, r, o) {
  return openBlock(), createElementBlock(Fragment, null, [
    n3.hasCustomSlotContent ? (openBlock(), createElementBlock("div", et, [
      createBaseVNode("div", mergeProps({ ref: "markerRef" }, n3.$attrs), [
        renderSlot(n3.$slots, "content")
      ], 16)
    ])) : createCommentVNode("", true),
    renderSlot(n3.$slots, "default")
  ], 64);
}
var Tt = X(Qe, [["render", tt]]);
var st = (n3) => n3 === "Marker";
var rt = (n3) => n3 === re;
var W = (n3, e, t, s) => {
  const r = ref(), o = inject(B, ref()), a = inject(Z, ref()), l = inject(fe, ref()), i = computed(
  ...
  return watch(
    ...
    (d, [u, c]) => {
      ...
      !o.value || !a.value || !h || (r.value ? (r.value.setOptions(t.value), i.value && ((p = l.value) == null || p.removeMarker(r.value), (f = l.value) == null || f.addMarker(r.value))) : (st(n3) ? r.value = markRaw(
        new a.value[n3](t.value)
      ) : rt(n3) ? r.value = markRaw(
        new a.value[n3](t.value)
      ) : r.value = markRaw(
        new a.value[n3]({
          ...t.value,
...
var $t = defineComponent({
  ...
  emits: Ce,
  setup(n3, { emit: e, expose: t, slots: s }) {
    const r = toRef(n3, "options"), o = W("Marker", Ce, r, e);
    return provide(pe, o), t({ marker: o }), () => {
      var a;
...
var be = H.concat(["bounds_changed"]);
...
var Me = H.concat(["center_changed", "radius_changed"]);
...
var nt = defineComponent({
  ...
  setup(n3, { emit: e }) {
    const t = ref(null), s = inject(B, ref()), r = inject(Z, ref()), o = inject(Te, ref(false)), a = watch(
      [o, r, t],
      ([d, u, c]) => {
...
var at = defineComponent({
  ...
  setup(n3, { slots: e, emit: t, expose: s }) {
    const r = ref(), o = ref(), a = inject(B, ref()), l = inject(Z, ref()), i = inject(pe, ref());
    let d, u = n3.modelValue;
    const c = computed(() => {
      var m;
      return (m = e.default) == null ? void 0 : m.call(e).some((g) => g.type !== Comment);
    }), h = (m) => {
...
function ct(n3, e, t, s, r, o) {
  return n3.hasSlotContent ? (openBlock(), createElementBlock("div", lt, [
    createBaseVNode("div", mergeProps({ ref: "infoWindowRef" }, n3.$attrs), [
      renderSlot(n3.$slots, "default", {}, void 0, true)
    ], 16)
  ])) : createCommentVNode("", true);
}
var Nt = X(at, [["render", ct], ["__scopeId", "data-v-cbe1707b"]]);
var Ee = [
  Int8Array,
  Uint8Array,
  Uint8ClampedArray,
...
var me = class _me {
  ...
  constructor(e, t = 64, s = Float64Array, r) {
    ...
    r && r instanceof ArrayBuffer ? (this.data = r, this.ids = new this.IndexArrayType(this.data, K, e), this.coords = new this.ArrayType(this.data, K + l + i, e * 2), this._pos = e * 2, this._finished = true) : (this.data = new ArrayBuffer(K + a + l + i), this.ids = new this.IndexArrayType(this.data, K, e), this.coords = new this.ArrayType(this.data, K + l + i, e * 2), this._pos = 0, this._finished = false, new Uint8Array(this.data, 0, 2).set([219, (ie << 4) + o]), new Uint16Array(this.data, 2, 1)[0] = t, new Uint32Array(this.data, 4, 1)[0] = e);
  }
  /**
...
function $e(n3, e, t, s, r, o) {
  for (; r > s; ) {
    ...
    const a = e[2 * t + o];
    let l = s, i = r;
    for (Y(n3, e, s, t), e[2 * r + o] > a && Y(n3, e, s, r); l < i; ) {
      for (Y(n3, e, l, i), l++, i--; e[2 * l + o] < a; )
        l++;
      for (; e[2 * i + o] > a; )
        i--;
    }
    e[2 * s + o] === a ? Y(n3, e, s, i) : (i++, Y(n3, e, i, r)), i <= t && (s = i + 1), t <= i && (r = i - 1);
  }
}
function Y(n3, e, t, s) {
...
var Be = (n3, e, t) => {
  const { northEast: s, southWest: r } = ft(n3, e), o = mt({ northEast: s, southWest: r }, t);
  return gt(o, e);
};
var xe = (n3, e, t) => {
...
var mt = ({ northEast: n3, southWest: e }, t) => (n3.x += t, n3.y -= t, e.x -= t, e.y += t, { northEast: n3, southWest: e });
var gt = ({ northEast: n3, southWest: e }, t) => {
...
var yt = (n3) => n3.map((t) => new J({
  position: k.getPosition(t),
  markers: [t]
}));
var _t = class extends Ze {
  constructor(e) {
...
var ve = class _ve {
  constructor() {
    bt(_ve, google.maps.OverlayView);
  }
};
var F;
(function(n3) {
...
var Dt = defineComponent({
  ...
  emits: Ae,
  setup(n3, { emit: e, expose: t, slots: s }) {
    const r = ref(), o = inject(B, ref()), a = inject(Z, ref());
    return provide(fe, r), watch(
      o,
      () => {
        o.value && (r.value = markRaw(
          new Ot({
            ...
            algorithm: new wt(n3.options.algorithmOptions ?? {}),
            ...n3.options
          })
        ), Ae.forEach((l) => {
          var i;
...
function St(n3, e, t, s, r, o) {
  return n3.hasSlotContent ? (openBlock(), createElementBlock("div", Pt, [
...
var Ft = X(Et, [["render", St], ["__scopeId", "data-v-2d2d343a"]]);
      ...
      ([r, o], [a, l]) => {
        ...
        if (t.value && s.value && i) {
          ...
          if (o.data && !(o.data instanceof s.value.MVCArray)) {
            ...
            d = o;
          e.value ? e.value.setOptions(d) : e.value = markRaw(
